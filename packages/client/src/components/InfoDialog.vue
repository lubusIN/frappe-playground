  ...
  >
    ...
    <div class="bg-surface-elevation-1 rounded-6 shadow-xl overflow-hidden flex flex-col relative text-left">
      ...
      <div class="p-5 pb-0">
        ...
        <Tabs :tabs="[{ label: 'About', value: 'About' }, { label: 'Credentials', value: 'Credentials' }, { label: 'Insights', value: 'Insights' }]" v-model="activeTab" class="w-full">
          <template #tab-panel="{ tab }">
            <div v-if="tab.label === 'About'" class="pt-4 min-h-[220px] flex flex-col gap-1">
              <a
                ...
                class="flex items-center justify-between p-2 -mx-2 rounded-4 hover:bg-surface-gray-2 transition-colors text-ink-gray-9 text-sm"
              >
            ...
            <div v-if="tab.label === 'Credentials'" class="pt-4 min-h-[220px] flex flex-col gap-4">
            ...
            <div v-if="tab.label === 'Insights'" class="pt-4 min-h-[220px] flex flex-col gap-3 text-left">
...
async function copyUsername(text) {
  try {
